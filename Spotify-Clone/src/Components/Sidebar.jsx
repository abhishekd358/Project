...
const Sidebar = () => {
  ...
  return (
    ...
    {/* sidebar card 1 home and search */}
      <div id="widget-1" className=" bg-[#121212] max-w-md mx-2 my-2 px-7 py-4 flex flex-col gap-5 rad rounded-lg cursor-pointer">
    ...
    {/* Library card */}
    <div id="widget-2" className="bg-[#121212] max-w-md h-[80%] mx-2 my-2 px-3 py-4 flex flex-col gap-4 rounded-lg">
