...
const BuyCredit = () => {
  ...
  return (
    <div className="min-h-[80vh] pt-14 mb-10 flex flex-col justify-center items-center">
      <p className="border rounded-full border-neutral-500 px-6 mb-8 py-2 bg-white text-stone-500 max-w-40">
        OUR PLANS
      </p>
      ...
      <div className="flex flex-wrap justify-center items-center gap-6 text-left">
        {plans.map((data, index) => (
          <div
            key={index}
            className="bg-white drop-shadow-sm border rounded-lg text-gray-600 border-zinc-200 w-80 h-90 px-8 py-12 hover:scale-105 transition-all duration-500"
          >
