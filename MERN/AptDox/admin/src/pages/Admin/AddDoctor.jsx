...
const AddDoctor = () => {
  ...
  {/* main container */}
  <div className="bg-white px-4 sm:px-8 py-6 sm:py-8 border rounded w-full max-w-4xl max-h-[85vh] overflow-auto">
    {/* inside of conatiner */}
    <div className="flex items-center gap-4 mb-8 text-gray-500 flex-wrap sm:flex-nowrap">
    ...
    <div className="flex flex-col lg:flex-row items-start gap-8 sm:gap-10 text-gray-600">
      {/* left side */}
    ...
    <button
      type="submit"
      className="bg-blue-500 hover:bg-blue-600 px-8 sm:px-10 py-3 mt-4 text-white rounded-full transition-colors duration-200"
    >
      Add Doctor
    </button>
  </div>
